...
class Options:
    ...
    def add_optim_options(self):
        ...
        self.parser.add_argument("--accumulation_steps", type=int, default=2, help="gradient accumulation")
    ...
    def add_modeling_options(self):
        ...
        self.parser.add_argument(
            "--rerank_retriever_model_path",
            type=str,
            default="",
            help="path to contriever model for fc data to init from",
        )
        ...
        # Generation options
        self.parser.add_argument("--generation_max_length", type=int, default=200)
        ...
        self.parser.add_argument(
            "--lgret",
            action="store_true",
            help="Article-level retrieval loss",
        ) 

        self.parser.add_argument(
            "--lcret",
            action="store_true",
            help="Chunk-level retrieval loss",
        ) 

        self.parser.add_argument(
            "--lglm",
            action="store_true",
            help="Article-level generation loss",
        ) 

        self.parser.add_argument(
            "--lclm",
            action="store_true",
            help="Chunk-level generation loss",
        ) 
    ...
    def parse(self):
        ...
        if opt.gold_score_mode == "pdist":  
            opt.gold_score_mode = "ppmean"
        if opt.gold_score_mode == "adist": 
